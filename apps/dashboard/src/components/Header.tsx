...
import { RefreshCcw, LogOut, ChevronDown, Home as HomeIcon, User, FileSpreadsheet, Settings } from 'lucide-react';
            ...
            {isDropdownOpen && (
              <div className="profile-dropdown">
                <div className="dropdown-user-info">
                  <span className="dropdown-user-name" title={user?.name || 'Usuário'}>{user?.name || 'Usuário'}</span>
